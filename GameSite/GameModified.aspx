<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GameModified.aspx.cs" Inherits="GameSite.GameModified" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="register-form" method="post" role="form" style="display: none;">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-6">
                    <asp:Button Text="Güncelle" ID="btnModified" CssClass="btn btn-warning" OnClick="btnModified_Click" runat="server" />
